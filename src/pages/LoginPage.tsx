...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Kirishda xatolik yuz berdi. Ehtimol login yoki parol noto\'g\'ri.');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-cyber-black pt-24 pb-12 flex flex-col justify-center items-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-cyber-blue/10 rounded-full blur-3xl mix-blend-screen" />
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl mix-blend-screen" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Tizimga kirish</h1>
          <p className="text-gray-400 text-sm">Darslarni davom ettirish uchun kiring</p>
        </div>

        {(location.state as any)?.message && (
           <div className="mb-6 bg-yellow-500/10 border border-yellow-500/50 text-yellow-500 p-3 rounded-lg text-sm flex items-start gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center px-1">
              ...
              <a href="#" className="text-[10px] text-cyber-blue hover:underline">Parolni unutdingizmi?</a>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          ...
          <Link to="/signup" className="text-cyber-blue hover:text-blue-400 font-bold hover:underline">
            Ro'yxatdan o'ting
          </Link>
        </p>
      </motion.div>
